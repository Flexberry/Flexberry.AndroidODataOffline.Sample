...
```
В конструкторе <code>Destination</code> объявлено 2 аргумента: <code>route</code> -- базовый маршрут, <params> -- параметры для этого маршрута. 
